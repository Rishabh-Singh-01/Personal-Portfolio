    ...
    return (
        <div className="about-me">
            ...
            <p className="about-me--generalInfo">
                ...
                <br />
                <br />
                Despite being in Electronics branch, by no means I am slacking in my area of interests. One of the things I greatly enjoy is Web development. Building something that id functional and user-friendly but at the same time attractive is something I take proud in as a fresher :p .I also am decent in DSA(well atleast imo hahahaha) and currently doing more work to improve my problem solving skills.
                <br />
